...
class UGVTDataset(BaseDataset):

    def __init__(self):
        super().__init__()
        # self.base_path = "/home/liuyao/Datasets/smallobject/"
        # self.base_path = '/DATA/lcl/A-data-tiny'
        self.base_path = '/home/xyl/pysot-master/testing_dataset/UGVT'
    ...
    def _construct_sequence(self, sequence_info):
        ...
        return Sequence(sequence_info['name'], frames, 'ugvt', ground_truth_rect[init_omit:, :],
    ...
    def _get_sequence_info_list(self):
        ...
        for root, dirs, files in os.walk('/home/xyl/pysot-master/testing_dataset/UGVT'):
            for dir in dirs:
                if dir == 'img':
        ...
        for i in range(len(sequence_dir)):
            ...
            sequence_info["path"] = sequence_dir[i]  + '/img'   # UGVT 各序列的图片在 img 中，需要修改，和DTB70一样
