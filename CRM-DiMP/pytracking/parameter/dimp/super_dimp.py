...
def parameters():
    ...
    params.net = NetWithBackbone(net_path='/home/xyl/xyl-code/CRM-DiMP/pytracking/networks/CRM-DiMP.tar',
                                 use_gpu=params.use_gpu)
    params.theta = 0.6  # tempalte sharing threshold xyl20231219
